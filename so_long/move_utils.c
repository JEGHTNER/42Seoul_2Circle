...
/*   Updated: 2023/01/21 15:45:43 by jehelee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_w(t_map *map)
{
	...
	y = map->p_place[0];
	x = map->p_place[1];
	if (y - 1 < 0 || map->p_list->prev->content[x] == '1' || (map->c_count != 0 && map->p_list->prev->content[x] == 'E'))
		return ;
    ft_printf("%d moves\n",++(map->move));
...
void	move_s(t_map *map)
{
	...
	if (y + 1 < 0 || map->p_list->next->content[x] == '1'||(map->c_count != 0 && map->p_list->next->content[x] == 'E'))
		return ;
    ft_printf("%d moves\n",++(map->move));
	map->p_list->content[x] = '0';
	mlx_put_image_to_window(map->mlx, map->win, map->img_ground, x * 64, y * 64);	map->p_place[0] = y + 1;
...
void	move_a(t_map *map)
{
	...
	if (x - 1 < 0 || map->p_list->content[x - 1] == '1'|| (map->c_count != 0 && map->p_list->content[x - 1] == 'E'))
		return ;
    ft_printf("%d moves\n",++(map->move));
	map->p_list->content[x] = '0';
	mlx_put_image_to_window(map->mlx, map->win, map->img_ground, x * 64, y * 64);	map->p_place[1] = x - 1;
...
void	move_d(t_map *map)
{
	...
	if (x + 1 < 0 || map->p_list->content[x + 1] == '1' || (map->c_count != 0 && map->p_list->prev->content[x + 1] == 'E'))
		return ;
    ft_printf("%d moves\n",++(map->move));
	map->p_list->content[x] = '0';
	mlx_put_image_to_window(map->mlx, map->win, map->img_ground, x * 64, y * 64);	map->p_place[1] = x + 1;
